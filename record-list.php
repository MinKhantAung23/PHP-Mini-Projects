...
<section class=" bg-gray-100 p-10 rounded-lg">
    ...
    <section>
        ...
        while (!feof($fileStream)) :
            ...
            if ($content === "\n") continue;
        ?>
            <p class="font-mono text-gray-700 bg-white border p-4 mb-2 rounded">
                <?= $content; ?>
            </p>
        <?php endwhile; ?>
        <a href="./index.php" type="button" class="w-full justify-center py-3 px-4 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none">
            Calculate Again
        </a>
    </section>
</section>
